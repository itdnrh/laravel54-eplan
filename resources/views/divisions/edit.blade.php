...
@section('content')
    ...
    <section
        ...
        ng-init="
            initForms({ departs: {{ $departs }} }, 0);
            getById('{{ $division->ward_id }}', setEditControls);
        "
    >
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form
                        method="post"
                        id="frmEditDivision"
                        name="frmEditDivision"
                        action="{{ url('/divisions/update/'.$division->ward_id) }}"
                    ...
                    >
                        ...
                        <div class="box-footer clearfix">
                            <button
                                ...
                                ng-click="formValidate($event, '/divisions/validate', division, 'frmEditDivision', update)"
                            >
                                บันทึกการแก้ไข
                            </button>
                        </div><!-- /.box-footer -->
