...
@section('content')
    ...
    <section
        ...
        getById({{ $invoice->ivh_id }}, setEditControls);
        "
    >
            ...
            <div class="col-md-12">
                ...
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="box-title">แก้ไขรายการควบคุมกำกับติดตาม @{{ invoice.depart_id }}</h3>
                    </div>

                    <form id="frmEditInvoice" name="frmEditInvoice" method="post" action="{{ url('/invoice/update/'.$invoice->ivh_id) }}" role="form" enctype="multipart/form-data">
                        <input
                            type="hidden"
                            id="user"
                            name="user"
                            ...
                            <div class="row">
                                ...
                                >
                                    ...
                                    <select id="invoice_item_id"
                                            ...
                                            ng-change="
                                                setcboInvoice(invoice.invoice_item_id);
                                                clearNewItem();
                                            "
                                            class="form-control">
                                ...
                                >
                                    ...
                                    <select id="invoice_detail_id"
                                            ...
                                            ng-change="
                                                setcboInvoiceItemDetail(invoice.invoice_detail_id);
                                                clearNewItem();
                                            "
                        ...
                        <div class="box-footer clearfix">
                            <button
                                ng-click="formValidate($event, '/invoice/validate', invoice, 'frmEditInvoice', update)"
