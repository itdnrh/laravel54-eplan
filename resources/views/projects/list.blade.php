                            ...
                            <tbody>
                                <tr ng-repeat="(index, project) in projects">
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <span class="label label-danger" ng-show="project.status == 9">
                                            ปิดโครงการแล้ว
                                        </span>
                                    ...
                                    <td style="text-align: center;">
                                        <div style="display: flex; justify-content: center; gap: 2px;">
                                            ...
                                            <a  ng-click="edit(project.id)"
                                                ng-show="
                                                    (project.approved != 'A' && ({{ Auth::user()->memberOf->depart_id }} == project.owner_depart || {{ Auth::user()->memberOf->depart_id }} == '4')) ||
                                                    (project.approved == 'A' && {{ Auth::user()->memberOf->depart_id }} == '4')
                                                "
                                            ...
                                            <form
                                                ...
                                                ng-show="project.approved != 'A' && ({{ Auth::user()->memberOf->depart_id }} == project.owner_depart || {{ Auth::user()->memberOf->depart_id }} == '4')"
                                            >
                                                {{ csrf_field() }}
                                                <button
                                                    type="submit"
