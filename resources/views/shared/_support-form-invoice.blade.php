<div class="modal fade" id="support-form-plan-invoice" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-default">@{{ invoiceDetail.doc_prefix }}/</button>
                                </div>
                                <input
                                    type="text"
                                    id="doc_no"
                                    name="doc_no"
                                    ng-model="invoiceDetail.doc_no"
                                    class="form-control"
                                />
                            </div>
                        </div>
                        <div class="col-md-6 form-group">
                            ...
                            <input
                                ...
                                id="doc_date"
                                name="doc_date"
                                ng-model="invoiceDetail.doc_date"
                                class="form-control"
                            />
                        </div>
                        <!-- <div class="col-md-6 form-group">
