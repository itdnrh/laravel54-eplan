<div class="modal fade" id="addons-list" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
            ...
            <form action="">
                ...
                <div class="modal-body" style="padding-bottom: 0;">
                    ...
                    <table class="table table-bordered table-striped table-sm" style="font-size: 14px; margin-bottom: 10px;">
                        ...
                        <tbody>
                            <tr ng-repeat="(index, plan) in addOns">
                                <td style="text-align: center;">@{{ index+addOns_pager.from }}</td>
                                ...
                                <td style="text-align: center;">
                                        <a  href="#"
                                            ng-click="onSelectedAddOnItem($event, plan)"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <span class="pull-left" style="margin-top: 5px;">
                                หน้า @{{ addOns_pager.current_page }} จาก @{{ addOns_pager.last_page }} | 
                                จำนวน @{{ addOns_pager.total }} รายการ
                            </span>
                        </div>
                        <div class="col-md-4">
                            <ul class="pagination pagination-sm no-margin">
                                <li ng-if="addOns_pager.current_page !== 1">
                                    <a ng-click="getAddonItemsWithUrl($event, addOns_pager.path+ '?page=1', '0-1', setAddOns)" aria-label="Previous">
                                        <span aria-hidden="true">First</span>
                                    </a>
                                </li>

                                <li ng-class="{'disabled': (addOns_pager.current_page==1)}">
                                    <a ng-click="getAddonItemsWithUrl($event, addOns_pager.prev_page_url, '0-1', setAddOns)" aria-label="Prev">
                                        <span aria-hidden="true">Prev</span>
                                    </a>
                                </li>

                                <!-- <li ng-if="addOns_pager.current_page < addOns_pager.last_page && (addOns_pager.last_page - addOns_pager.current_page) > 10">
                                    <a href="@{{ addOns_pager.url(addOns_pager.current_page + 10) }}">
                                        ...
                                    </a>
                                </li> -->

                                <li ng-class="{'disabled': (addOns_pager.current_page==addOns_pager.last_page)}">
                                    <a ng-click="getAddonItemsWithUrl($event, addOns_pager.next_page_url, '0-1', setAddOns)" aria-label="Next">
                                        <span aria-hidden="true">Next</span>
                                    </a>
                                </li>

                                <li ng-if="addOns_pager.current_page !== addOns_pager.last_page">
                                    <a ng-click="getAddonItemsWithUrl($event, addOns_pager.path+ '?page=' +addOns_pager.last_page, '0-1', setAddOns)" aria-label="Previous">
                        ...
                        <div class="col-md-4">
                            <button type="button" class="btn btn-danger" ng-click="onSelectedAddOnItem($event, null)">
                                ปิด
                            </button>
                        </div>
                    </div>
