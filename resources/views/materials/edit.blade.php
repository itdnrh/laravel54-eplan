                ...
                <div class="box box-warning">
                    ...
                    <form id="frmEditMaterial" name="frmEditMaterial" method="post" action="{{ url('/materials/update/'.$material->id.'?in_stock='.$in_stock) }}" role="form" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div
                                    ...
                                    ng-class="{'has-error has-feedback': checkValidate(material, 'item_id')}"
                                >
                                    ...
                                    <span class="help-block" ng-show="checkValidate(material, 'item_id')">
                        ...
                        <div class="box-footer clearfix">
                            <button
                                ng-click="onValidateForm($event, '/materials/validate', material, 'frmEditMaterial', update)"
