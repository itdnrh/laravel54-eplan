...
@section('content')
    ...
    <section class="content-header">
        <h1>
            เพิ่มรายการขอสนับสนุน
            <!-- <small>preview of simple tables</small> -->
        </h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">หน้าหลัก</a></li>
            <li class="breadcrumb-item active">เพิ่มรายการขอสนับสนุน</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title">เพิ่มรายการขอสนับสนุน</h3>
                    </div>

                    <form id="frmNewInvoiceDetail" name="frmNewInvoiceDetail" method="post" action="{{ url('/invoicedetail/store') }}" role="form" enctype="multipart/form-data">
                        <input
                            type="hidden"
                            id="user"
                            name="user"
                        ...
                        <div class="box-body">
                            <div class="row">
                              ...
                              ng-class="{'has-error has-feedback': checkValidate(invoiceDetail, 'ivh_id')}">
                                ...
                                "
                                >
                                  <option value="" disabled selected>-- ประเภทบิล --</option>
