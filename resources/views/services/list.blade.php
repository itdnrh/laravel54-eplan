                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    id="isApproved"
                                    ng-model="isApproved"
                                    ng-click="setIsApproved($event, 3, '', setPlans);"
                                    style="margin-left: 10px;"
                                /> แสดงเฉพาะรายการที่อนุมัติแล้ว
                            </div>
                            <div class="col-md-6">
                                <a href="{{ url('/services/add') }}" class="btn btn-primary pull-right" ng-click="isDisabledRequest($event, {{ Auth::user()->memberOf->depart_id }})"><!-- // -->
                                ...
                                <a href="#" ng-show="services.length" ng-click="exportListToPdf($event)" class="btn btn-danger pull-right" style="margin-right: 5px;">
                            ...
                            <div class="col-md-4">
                                <ul class="pagination pagination-sm no-margin pull-right" ng-show="pager.last_page > 1">
                                    <li ng-if="pager.current_page !== 1">
                                        <a href="#" ng-click="getPlansWithUrl($event, pager.path+ '?page=1', 3, '', setPlans)" aria-label="Previous">
                                            <span aria-hidden="true">First</span>
                                        </a>
                                    </li>
                                
                                    <li ng-class="{'disabled': (pager.current_page==1)}">
                                        <a href="#" ng-click="getPlansWithUrl($event, pager.prev_page_url, 3, '', setPlans)" aria-label="Prev">
                                    ...
                                    <li ng-class="{'disabled': (pager.current_page==pager.last_page)}">
                                        <a href="#" ng-click="getPlansWithUrl($event, pager.next_page_url, 3, '', setPlans)" aria-label="Next">
                                            <span aria-hidden="true">Next</span>
                                        </a>
                                    </li>

                                    <li ng-if="pager.current_page !== pager.last_page">
                                        <a href="#" ng-click="getPlansWithUrl($event, pager.path+ '?page=' +pager.last_page, 3, '', setPlans)" aria-label="Previous">
