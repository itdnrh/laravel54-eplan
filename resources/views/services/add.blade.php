                ...
                <div class="box box-primary">
                    ...
                    <form id="frmNewService" name="frmNewService" method="post" action="{{ url('/services/store') }}" role="form" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <!-- <div
                                    ...
                                    ng-class="{'has-error has-feedback': checkValidate(service, 'request_cause')}"
                                >
                                    <label>ประเภทการตัดยอด : <span class="required-field">*</span></label>
                                    <div class="form-control checkbox-groups">
                                        <div class="checkbox-container">
                                            <input  type="radio"
                                                    id="request_cause"
                                ...
                                >
                                    ...
                                    <div class="input-group">
                                        <div class="form-control" readonly>
                                            @{{ service.addon_detail.plan_no }}
                                            @{{ service.addon_detail.plan_item.item.item_name }}
                                            <span ng-show="service.addon_detail">
                                                งบประมาณ @{{ service.addon_detail.plan_item.sum_price | currency:'':2 }} บาท
                                            </span>
                                        </div>
                                        <input
                                            type="hidden"
                                    ...
                                    <span class="help-block" ng-show="checkValidate(service, 'addon_id')">
                        ...
                        <div class="box-footer clearfix">
                            <button
                                ng-click="onValidateForm($event, '/services/validate', service, 'frmNewService', store)"
