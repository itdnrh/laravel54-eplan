...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">เพิ่มกลุ่มงาน</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">เพิ่มกลุ่มงาน</h3>
                    </div>
                    ...
                    >
                        ...
                        <div class="box-footer clearfix">
                            <button
                                ...
                                ng-click="formValidate($event, '/departs/validate', depart, 'frmNewDepart', store)"
                            >
                                บันทึก
                            </button>
                        </div><!-- /.box-footer -->
