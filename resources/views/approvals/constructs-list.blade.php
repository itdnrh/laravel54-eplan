                            ...
                            <div class="col-md-4">
                                <ul class="pagination pagination-sm no-margin pull-right" ng-show="plans_pager.last_page > 1">
                                    <li ng-if="plans_pager.current_page !== 1">
                                        <a href="#" ng-click="getDataWithUrl($event, plans_pager.path+ '?page=1', { type: 4 }, setPlans)" aria-label="Previous">
                                            <span aria-hidden="true">First</span>
                                        </a>
                                    </li>
                                
                                    <li ng-class="{'disabled': (plans_pager.current_page==1)}">
                                        <a href="#" ng-click="getDataWithUrl($event, plans_pager.prev_page_url, { type: 4 }, setPlans)" aria-label="Prev">
                                    ...
                                    <li ng-class="{'disabled': (plans_pager.current_page==plans_pager.last_page)}">
                                        <a href="#" ng-click="getDataWithUrl($event, plans_pager.next_page_url, { type: 4 }, setPlans)" aria-label="Next">
                                            <span aria-hidden="true">Next</span>
                                        </a>
                                    </li>

                                    <li ng-if="plans_pager.current_page !== plans_pager.last_page">
                                        <a href="#" ng-click="getDataWithUrl($event, plans_pager.path+ '?page=' +plans_pager.last_page, 4, setPlans)" aria-label="Previous">
