...
class PlanController extends Controller
{
    ...
    public function search(Request $req)
    {
        ...
        $type   = $req->get('type');
        $cate   = $req->get('cate');
        $faction = (Auth::user()->person_id == '1300200009261' || Auth::user()->memberOf->depart_id == '4') ? $req->get('faction') : Auth::user()->memberOf->faction_id;
        $depart = (Auth::user()->person_id == '1300200009261' || Auth::user()->memberOf->duty_id == '1' || Auth::user()->memberOf->depart_id == '4') ? $req->get('depart') : Auth::user()->memberOf->depart_id;
        $division = (Auth::user()->person_id == '1300200009261' || Auth::user()->memberOf->duty_id == '1' || Auth::user()->memberOf->duty_id == '2' || Auth::user()->memberOf->depart_id == '4') ? $req->get('division') : '';
    ...
    public function excel(Request $req)
    {
        ...
        $type   = $req->get('type');
        $cate   = $req->get('cate');
        $faction = (Auth::user()->person_id == '1300200009261' || Auth::user()->memberOf->depart_id == '4')
                        ? $req->get('faction')
