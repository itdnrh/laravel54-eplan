...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'account' => array(
            'driver'        => 'mysql',
            'host'          => env('DB_ACC_HOST', '127.0.0.1'),
            'port'          => env('DB_ACC_PORT', '3306'),
            'database'      => env('DB_ACC_DATABASE', 'forge'),
            'username'      => env('DB_ACC_USERNAME', 'forge'),
            'password'      => env('DB_ACC_PASSWORD', ''),
            'unix_socket'   => env('DB_ACC_SOCKET', ''),
            'charset'       => 'utf8',
            'collation'     => 'utf8_unicode_ci',
            'prefix'        => '',
            'strict'        => false,
